...
# ====================================================================== #
	...
	CREATE TABLE vehicles(
		...
		sold_or_leased varchar(9) DEFAULT ('available'),
		PRIMARY KEY(vin)
	);
...
# ====================================================================== #
	...
	INSERT INTO vehicles(vin, year, make, model, type, color, odometer, price, sold_or_leased)
		VALUE(10112,1993,'Ford','Explorer','SUV','Red',525123,9900.00,'sold'),
			(37846,2012,'Honda','Civic','Sedan','Gray',103221,6895.00, DEFAULT),
			(44875,2006,'Nissan','Altima','Sedan','Blue',137850,3995.00,'sold'),
			(27483,2018,'Toyota','Camry','Sedan','White',42123,7960.00, DEFAULT),
			(56291,2015,'Chevrolet','Silverado','Truck','Black',87250,4990.00, DEFAULT),
			(93742,2019,'Ford','F-150','Truck','Red',30210,2990.00,'sold'),
			(65837,2014,'Honda','Accord','Sedan','Silver',61500,4990.00,'leased'),
			(34980,2009,'Toyota','Corolla','Sedan','Blue',98755,5990.00, DEFAULT),
			(82376,2016,'Nissan','Rogue','SUV','Gray',46000,6990.00, DEFAULT),
			(48721,2011,'Ford','Mustang','Coupe','Red',75000,9980.00, DEFAULT),
			(15689,2017,'Hyundai','Sonata','Sedan','Black',36000,1990.00, DEFAULT),
			(72654,2013,'Chevrolet','Malibu','Sedan','White',80230,8990.00,'leased'),
			(36598,2010,'Honda','CR-V','SUV','Green',112450,990.00, DEFAULT),
			(84239,2012,'Toyota','Sienna','Van','Silver',94000,3990.00, DEFAULT),
			(20475,2008,'Nissan','Sentra','Sedan','Gray',128500,4990.00, DEFAULT),
			(61937,2019,'Subaru','Outback','SUV','Blue',20500,5990.00,'sold'),
			(50328,2015,'Ford','Escape','SUV','Black',63500,7990.00, DEFAULT),
			(10987,2007,'Chevrolet','Impala','Sedan','Red',144200,4490.00, DEFAULT),
			(78432,2018,'Honda','Pilot','SUV','White',31200,9990.00,'sold'),
			(27654,2014,'Toyota','Tacoma','Truck','Silver',70500,3990.00, DEFAULT),
			(62193,2010,'Ford','Focus','Hatchback','Blue',99800,5990.00, DEFAULT),
			(43827,2016,'Nissan','Versa','Sedan','Gray',48000,7230.00, DEFAULT),
			(89523,2005,'Honda','Odyssey','Van','Silver',169500,3790.00, DEFAULT),
			(12345,2013,'Toyota','Rav4','SUV','Blue',78000,14990.00, DEFAULT),
			(67890,2016,'Ford','Fusion','Sedan','Silver',55000,8990.00, DEFAULT),
			(24680,2011,'Honda','Fit','Hatchback','Red',89000,7990.00, DEFAULT),
			(13579,2017,'Chevrolet','Equinox','SUV','Black',42000,8990.00,'leased'),
			(98765,2014,'Nissan','Maxima','Sedan','White',69000,5990.00, DEFAULT),
			(54321,2009,'Toyota','Highlander','SUV','Gray',11500,11690.00,'leased'),
			(55776,2017,'Nissan','Pathfinder','SUV','Silver',38001,2990.00, DEFAULT),
			(77998,2014,'Toyota','Camry','Sedan','Blue',66001,7990.00,'leased'),
			(18224,2018,'Ford','F-150','Truck','Black',32001,9990.00,'sold'),
			(44851,2015,'Honda','CR-V','SUV','Silver',61001,7990.00, DEFAULT),
			(77881,2012,'Chevrolet','Impala','Sedan','Black',88001,4990.00, DEFAULT),
			(94010,2019,'Nissan','Sentra','Sedan','Gray',23001,11990.00,'sold'),
			(22336,2016,'Toyota','Corolla','Sedan','White',45001,7990.00, DEFAULT),
			(66708,2013,'Ford','Edge','SUV','Red',74001,5990.00,'leased'),
			(88445,2010,'Honda','Fit','Hatchback','Blue',98001,3990.00, DEFAULT),
			(33668,2008,'Chevrolet','Equinox','SUV','Silver',130001,990.00, DEFAULT),
			(55778,2017,'Nissan','Altima','Sedan','Black',38001,7990.00, DEFAULT),
			(77999,2014,'Toyota','Highlander','SUV','Gray',66001,6990.00, DEFAULT),
			(11225,2018,'Ford','Escape','SUV','White',32001,10990.00,'sold'),
			(44558,2015,'Honda','Civic','Sedan','Red',61002,7990.00, DEFAULT),
			(77882,2012,'Chevrolet','Cruze','Sedan','Gray',88002,6990.00, DEFAULT),
			(99012,2019,'Nissan','Altima','Sedan','Black',23002,10990.00,'leased'),
			(22337,2016,'Toyota','Prius','Hatchback','Green',45002,7990.00, DEFAULT),
			(66778,2013,'Ford','Escape','SUV','Red',74002,4990.00, DEFAULT),
			(88446,2010,'Honda','Civic','Sedan','Gray',98002,2990.00, DEFAULT),
			(33669,2008,'Chevrolet','Tahoe','SUV','White',130002,1990.00,'leased'),
			(55779,2017,'Nissan','Pathfinder','SUV','Silver',38002,10990.00, DEFAULT),
			(77993,2014,'Toyota','Camry','Sedan','Blue',66002,15990.00, DEFAULT),
			(18226,2018,'Ford','F-150','Truck','Black',32002,7990.00,'sold'),
			(44559,2015,'Honda','CR-V','SUV','Silver',61002,6990.00, DEFAULT),
			(77883,2012,'Chevrolet','Impala','Sedan','Black',88002,4990.00,'leased'),
			(99013,2019,'Nissan','Sentra','Sedan','Gray',23002,10995.00,'sold'),
			(22338,2016,'Toyota','Corolla','Sedan','White',45002,8995.00, DEFAULT),
			(66709,2013,'Ford','Edge','SUV','Red',74002,17995.00, DEFAULT),
			(88447,2010,'Honda','Fit','Hatchback','Blue',98002,8995.00, DEFAULT),
			(33670,2008,'Chevrolet','Equinox','SUV','Silver',130002,1995.00,'leased'),
			(77997,2014,'Toyota','Highlander','SUV','Gray',66002,6995.00, DEFAULT);
